...
// User
const accessTokenKey = "admission_access_token";
...
// for all subjects status passed
export const setShowInfo = (isHave: string) => Cookies.set("show_info", isHave);
export const getShowInfo = () => Cookies.get("show_info");
